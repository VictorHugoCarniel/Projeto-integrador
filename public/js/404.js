...
// Milk Spill
var milkSpill = new TimelineMax().to("#milk-spill--large", 60, {
    scale: 1.25,
...
// Face Hover
var face = new TimelineMax({ yoyo: true, repeat: -1 }).to("#milk-face", 10, {
    yPercent: -15,
    ease: Power1.easeInOut
});
